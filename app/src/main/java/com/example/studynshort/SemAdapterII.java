...
public class SemAdapterII extends RecyclerView.Adapter<SemAdapterII.ViewHolder>{
    private List<ModelClass> semList;
    Context context;

    public SemAdapterII(List<ModelClass> semList, Context context) {
    ...
    @NonNull
    @Override
    public SemAdapterII.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_item, parent, false);
      return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SemAdapterII.ViewHolder holder, int position) {
