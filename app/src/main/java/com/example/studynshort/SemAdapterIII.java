...
public class SemAdapterIII extends RecyclerView.Adapter<SemAdapterIII.ViewHolder>{
    private List<ModelClass> semList;
    Context context;

    public SemAdapterIII(List<ModelClass> semList, Context context) {
    ...
    @NonNull
    @Override
    public SemAdapterIII.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_item, parent, false);
        return new SemAdapterIII.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SemAdapterIII.ViewHolder holder, int position) {
