...
public class SemAdapterV extends RecyclerView.Adapter<SemAdapterV.ViewHolder>{
    private List<ModelClass> semList;
    Context context;

    public SemAdapterV(List<ModelClass> semList, Context context) {
    ...
    @NonNull
    @Override
    public SemAdapterV.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_item, parent, false);
        return new SemAdapterV.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SemAdapterV.ViewHolder holder, int position) {
