...
public class SemAdapterIV extends RecyclerView.Adapter<SemAdapterIV.ViewHolder>{
    private List<ModelClass> semList;
    Context context;

    public SemAdapterIV(List<ModelClass> semList, Context context) {
    ...
    @NonNull
    @Override
    public SemAdapterIV.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_item, parent, false);
        return new SemAdapterIV.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SemAdapterIV.ViewHolder holder, int position) {
