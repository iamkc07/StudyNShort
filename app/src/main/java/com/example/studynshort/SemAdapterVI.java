...
public class SemAdapterVI extends RecyclerView.Adapter<SemAdapterVI.ViewHolder>{
    private List<ModelClass> semList;
    Context context;

    public SemAdapterVI(List<ModelClass> semList, Context context) {
    ...
    @NonNull
    @Override
    public SemAdapterVI.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_item, parent, false);
        return new SemAdapterVI.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SemAdapterVI.ViewHolder holder, int position) {
